...
export {user, currentLoc, changeCurrentLoc, login, logOut, printHelp, createAccount, modifyAccount, closeAccount,
    doesAccountExist, transferFunds, depositFunds, withdrawFunds, requestFunds, fundRequests};
...
// changeCurrentLoc is used to change currentLoc value through export function
function changeCurrentLoc(string) {
    currentLoc = string;
