...
const jokes = [
    ...
    },
    {
        id: 404,
        joke:
      "When Chuck Norris was born, he immediately had sex with the first nurse he saw. " +
      "He was her first. She was his third. That afternoon.",
        categories: [],
    },
    {
        id: 13,
    ...
    },
    {
        id: 167,
        joke:
      "As a teen, Chuck Norris had sex with every nun in a convent tucked away in the hills of " +
    ...
    },
    {
        id: 26,
        joke:
      "Chuck Norris is the only human being to display the Heisenberg uncertainty principle -" +
      "you can never know both exactly where and how quickly he will roundhouse-kick you in the face.",
        categories: ["nerdy"],
    },
    {
        id: 384,
    ...
    },
    {
        id: 380,
        joke:
      "Chuck Norris does not follow fashion trends, they follow him. But then he turns around " +
      "and kicks their ass. Nobody follows Chuck Norris.",
        categories: [],
    },
    {
        id: 500,
    ...
    },
    {
        id: 165,
        joke:
      "The last thing you hear before Chuck Norris gives you a roundhouse kick? No " +
    ...
    },
    {
        id: 180,
        joke:
      "When J. Robert Oppenheimer said &quot;I am become death, the destroyer Of worlds&quot;, He " +
      "was not referring to the atomic bomb. He was referring to the Chuck Norris halloween costume he was wearing.",
        categories: [],
    },
    {
        id: 213,
    ...
    },
    {
      ...
      "This was proven a recently, when scientific analysis revealed what appeared to be Jean-Claude Van " +
    ...
    },
    {
        id: 283,
        joke:
      "The only sure things are Death and Taxes and when Chuck Norris goes to work for the IRS, " +
    ...
    },
    {
        id: 157,
        joke:
      "A study showed the leading causes of death in the United States are: 1. Heart disease, " +
    ...
    },
    {
        id: 304,
        joke:
      "It is said that looking into Chuck Norris' eyes will reveal your future. Unfortunately, " +
      "everybody's future is always the same: death by a roundhouse-kick to the face.",
        categories: [],
    },
    {
        id: 23,
    ...
    },
    {
        id: 399,
        joke:
      "In the movie &quot;The Matrix&quot;, Chuck Norris is the Matrix. If you pay close attention in " +
      "the green &quot;falling code&quot; scenes, you can make out the faint texture of his beard.",
        categories: [],
    },
    {
        id: 99,
    ...
    },
    {
        id: 388,
        joke:
      "The Manhattan Project was not intended to create nuclear weapons, it was meant to recreate the destructive " +
      "power in a Chuck Norris Roundhouse Kick. They didn't even come close.",
        categories: [],
    },
    {
        id: 94,
        joke:
      "Chuck Norris has the greatest Poker-Face of all time. He won the 1983 World Series of Poker, despite holding " +
      "only a Joker, a Get out of Jail Free Monopoly card, a 2 of clubs, 7 of spades and a green " +
    ...
    },
    {
        id: 369,
        joke:
      "A movie scene depicting Chuck Norris losing a fight with Bruce Lee was the product of history's most " +
      "expensive visual effect. When adjusted for inflation, the effect cost more than the Gross National " +
      "Product of Paraguay.",
        categories: [],
    },
    {
        id: 262,
        joke:
      "Chuck Norris used to play baseball. When Babe Ruth was hailed as the better player, Chuck Norris " +
    ...
    },
    {
        id: 88,
        joke:
      "Chuck Norris doesnt shave; he kicks himself in the face. The only thing that can cut " +
    ...
    },
    {
        id: 246,
        joke:
      "Chuck Norris? sperm is so badass, he had sex with Nicole Kidman, and 7 months later she " +
    ...
    },
    {
        id: 472,
        joke:
      "When Chuck Norris is web surfing websites get the message &quot;Warning: Internet Explorer has deemed " +
      "this user to be malicious or dangerous. Proceed?&quot;.",
        categories: ["nerdy"],
    },
    {
        id: 186,
    ...
    },
    {
        id: 428,
        joke:
      "In the first Jurassic Park movie, the Tyrannosaurus Rex wasn't chasing the jeep. Chuck Norris " +
      "was chasing the Tyrannosaurus AND the jeep.",
        categories: [],
    },
    {
        id: 241,
        joke:
      "Chuck Norris puts his pants on one leg at a time, just like the rest of us. The only difference " +
      "is, then he kills people.",
        categories: [],
    },
    {
        id: 37,
