...
function HeaderDropdown(props) {
    ...
    const renderDropDownButtons = () => {
        ...
        let mappedArr = props.productArray.map((product) => {
    ...
    return (
        ...
        <div id="header">
            ...
            <div className="dropdown">
                ...
                <form id="addNewProduct" style={viewAddNew ? { display: "flex" } : { display: "none" }}>
                    Image:
                    <input id="addIMG" type="text" onChange={(e) => setImage(e.target.value)} value={image} placeholder="Please enter the IMG url here..." />
                    Category:
                    <input id="addCategory" type="text" onChange={(e) => setCategory(e.target.value)} value={category} placeholder="Please enter the category here..." />
                    Title:
                    <input id="addTitle" type="text" onChange={(e) => setTitle(e.target.value)} value={title} placeholder="Please enter the title here..." />
                    Price:
                    <input id="addPrice" type="text" onChange={(e) => setPrice(e.target.value)} value={price} placeholder="Please enter the price here..." />
                    Description:
                    <textarea rows="4" cols="50" id="addDescription" form="addNewProduct" onChange={(e) => setDescription(e.target.value)} value={description} placeholder="Please enter the description here..."></textarea>
